	...
	return (
		<section className='fixed inset-0 flex flex-col items-center z-[1000] bg-dark canvas-grid'>
			...
			<div className='relative w-2/3 h-full max-h-full p-4 my-12 overflow-y-auto rounded-xl bg-stone-700'>
				...
				<button
					className='absolute flex items-center justify-center text-white transition-all bg-blue-600 border-2 border-blue-700 rounded-lg w-11 h-11 bg-opacity-20 top-6 right-8 hover:enabled:bg-blue-700 disabled:border-green-600 disabled:bg-green-600'
					disabled={isCopied}
					onClick={handleCopy}
				>
					{isCopied ? (
